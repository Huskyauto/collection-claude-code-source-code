...
const MODEL_COST_PER_MILLION: Record<string, { input: number; output: number }> = {
  ...
  "deepseek/deepseek-v3.2": { input: 0.27, output: 0.41 },
  "deepseek/deepseek-r1": { input: 0.55, output: 2.19 },
  "qwen/qwen3.5-plus-02-15": { input: 0.26, output: 2.08 },
  "qwen/qwen2.5-vl-72b-instruct": { input: 0.20, output: 0.40 },
  "minimax/minimax-m2.7": { input: 0.30, output: 1.10 },
