...
const TOOL_CATEGORIES: Record<string, string[]> = {
  ...
  presentations: ["create_slides", "create_pdf"],
...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  ...
  media: ["video", "audio", "narration", "voiceover", "tts", "text to speech", "voice over", "youtube", "ffmpeg", "mp4", "mp3", "record", "produce video", "create video", "make video", "assemble video", "generate audio", "thumbnail", "upload video"],
