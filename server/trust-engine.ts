...
const TRUST_CHANGES: Record<TrustEvent, { amount: number; categories?: TrustCategory[] }> = {
  ...
  cascading_failure: { amount: -55, categories: ["tool_compliance"] },
