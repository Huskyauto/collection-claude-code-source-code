...
export const DEPARTMENTS: Department[] = [
  {
    ...
    backupPersonaId: 6,
    triggerKeywords: ["strategy", "vision", "roadmap", "priorities", "OKR", "OKRs", "board", "investors", "partnerships", "company direction", "quarterly planning", "annual plan", "strategic", "fundraising", "pitch deck", "investor update", "crisis", "vendor evaluation", "partner evaluation", "decision", "goal setting", "launch", "product launch", "go to market", "quarterly review", "annual review", "business review", "QBR"],
  },
  {
    id: "engineering",
  ...
  },
  {
    ...
    backupAgent: "Scribe",
    backupPersonaId: 7,
    triggerKeywords: ["lead", "prospect", "pipeline", "deal", "proposal", "outreach", "pitch", "close", "client", "revenue target", "pricing", "quote", "sales", "cold email", "follow up", "CRM", "customer acquisition", "demo", "onboarding client", "upsell", "cross-sell", "contract negotiation"],
  },
  {
    id: "finance",
  ...
  },
  {
    ...
    backupAgent: "Forge",
    backupPersonaId: 3,
    triggerKeywords: ["system status", "health check", "API keys", "scheduling", "admin", "infrastructure", "uptime", "monitoring", "maintenance", "standup", "daily brief", "end of day", "weekly review", "incident", "calendar", "meeting prep", "operations", "status report"],
  },
  {
    id: "research",
    ...
    backupAgent: "Neptune",
    backupPersonaId: 10,
    triggerKeywords: ["market research", "competitive analysis", "trend", "industry report", "deep dive", "investigation", "benchmark", "landscape", "research", "competitor", "SWOT", "market size", "TAM", "SAM", "SOM", "due diligence", "background check", "industry analysis"],
  },
  {
    id: "data",
    name: "Data & Analytics",
...
export const OPERATION_SCAFFOLDS: OperationScaffold[] = [
  ...
  },
  {
    ...
    whenToUse: "Podcast script, audio narration, video assembly, multimedia content",
    ...
    stepSequence: [
      ...
      "For video: Assemble using create_slideshow_video",
      "Review output quality",
      "Upload to Google Drive",
    ],
    toolChain: ["generate_audio", "create_slideshow_video", "google_drive", "project"],
    deliverables: ["Audio/video file", "Script (if applicable)", "Production notes"],
    qualityGate: ["Audio is clear and properly paced", "Video transitions are smooth", "Content matches script"],
  ...
  },
  {
    ...
    toolChain: ["search_memory", "manage_content_calendar", "draft_social_post", "compose_social_post", "generate_social_image", "marketing_analytics"],
...
export const OPERATION_TOOL_MAP: Record<string, string[]> = {
  ...
  media_video: ["create_slideshow_video"],
  media_image: ["generate_social_image"],
};
