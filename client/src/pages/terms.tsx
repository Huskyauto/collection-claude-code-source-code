        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-6">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing or using VisionClaw ("the Service"), operated by AI Buddy LLC ("we," "us," or "our"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              VisionClaw is an agentic AI platform that provides multi-persona AI assistants, autonomous task execution, memory systems, voice interactions, and related AI-powered tools. The Service is provided on a subscription basis with various tiers offering different levels of access and capabilities.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
              <li>Response quality, speed, accuracy, and reliability are determined by your chosen AI provider and model, not by VisionClaw Agent.</li>
              <li>VisionClaw provides the agent framework, orchestration layer, tool integrations, memory systems, and infrastructure — but does not control the underlying AI model outputs when BYOK keys are in use.</li>
              ...
              <li>VisionClaw is not liable for any errors, failures, downtime, data loss, or degraded experience resulting from your third-party AI provider's service.</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              To the maximum extent permitted by law, AI Buddy LLC shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses, resulting from your use of the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              <strong className="text-foreground">Your Responsibility:</strong> It is your sole responsibility to download and back up any files, data, or content you wish to retain before the grace period expires. AI Buddy LLC is not liable for any data loss resulting from account deletion, whether requested by you or initiated due to terms violations.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              If you have any questions about these Terms of Service, please contact us at <a href="mailto:huskyauto@gmail.com" className="text-primary hover:underline">huskyauto@gmail.com</a>.
            </p>
          </section>
        </div>
