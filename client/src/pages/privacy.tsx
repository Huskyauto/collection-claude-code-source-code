        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-6">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              AI Buddy LLC ("we," "us," or "our") operates VisionClaw ("the Service"). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our Service. Please read this policy carefully.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mt-2">
              To exercise any of these rights, contact us at <a href="mailto:huskyauto@gmail.com" className="text-primary hover:underline">huskyauto@gmail.com</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="mt-2 text-muted-foreground">
              ...
              <p><a href="mailto:huskyauto@gmail.com" className="text-primary hover:underline">huskyauto@gmail.com</a></p>
            </div>
          </section>
        </div>
