          ...
          {current.content === "welcome" && (
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground max-w-md mx-auto">
                You now have access to a team of 14 specialized AI agents that can research, write, analyze, code, and run autonomous operations for you.
              </p>
          ...
          {current.content === "personas" && (
            <div className="space-y-4">
              ...
              <div className="grid gap-2">
                ...
                <p className="text-xs text-muted-foreground text-center pt-1">+ 6 more specialists (Scribe, Proof, Apollo, Atlas, Chief of Staff, Agent Blueprint)</p>
              </div>
            </div>
          )}
